...
- **Computer vision player analysis** - Automated video analysis, such as tracking or metrics extraction
...
- **Store account ownership** - Apple Developer, Google Play Console, certificates, legal policy hosting, screenshots, and reviewer communication are client-owned
- **Ongoing review operations** - Repeated compliance/review cycles, release management, and post-launch store operations are outside implementation assumptions unless separately agreed
...
- **Third-party accounts** - Client-owned third-party service accounts such as auth and storage should be assumed; developer may have temporary collaborator access
- **Post-delivery enhancements** - Additional features, web version, ongoing release operations, and continued development are separate scope
